...
import com.galih.myself.AboutDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ivFacebook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fb.setData(Uri.parse("https://www.facebook.com/uzumaki.prasetya/"));
                startActivity(fb);
            }
        });
        ...
        ivInstagram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ig.setData(Uri.parse("https://www.instagram.com/mochgalihprasetya/"));
                startActivity(ig);
            }
        });
        ...
        ivGithub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tw.setData(Uri.parse("https://github.com/MGalihPrasetya"));
                startActivity(tw);
            }
        });
        ...
        ivWhatsapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wa.setData(Uri.parse("https://api.whatsapp.com/send/?phone=6281211354936"));
                startActivity(wa);
            }
        });
        ...
        ivGmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gm.setData(Uri.parse("mailto:mgalihprasetya@gmail.com"));
                startActivity(gm);
            }
        });
        ...
        ivMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                map.setData(Uri.parse("https://goo.gl/maps/aKAX55gqySeJ98Kv6"));
                startActivity(map);
            }
        });
